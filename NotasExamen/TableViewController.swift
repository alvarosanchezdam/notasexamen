...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        do {
            notas = try contexto.fetch(fetchRequest)
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let managedObject = notas[indexPath.row]
        cell.textLabel?.text = managedObject.value(forKey: "asignatura") as! String
        cell.detailTextLabel?.text = managedObject.value(forKey: "calificacion") as! String
        return cell
    }
